//  const btns = document.querySelectorAll(".slide-controll");
...
renderProducts = (products) => {
    products.forEach(e => {
        ...
        best_product_list.insertAdjacentHTML("beforeend", prod)
    })
}
...
console.log(header)
const menuToggle = document.querySelector('#mb-menu-toggle');
menuToggle.addEventListener('click', () => header.classList.add('active'))

document.querySelector('#mb-menu-close').addEventListener('click', () => document.querySelector('.header').classList.remove('active'))